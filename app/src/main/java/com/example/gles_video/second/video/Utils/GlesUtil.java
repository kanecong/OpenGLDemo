...
/**
 * Created By gaorui on 2018/8/29
 */
public class GlesUtil {
    ...
    public static int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (status[0] != GLES20.GL_TRUE) {
            Log.e("gaorui", "createProgam: link error");
            Log.e("gaorui", "createProgam: " + GLES20.glGetProgramInfoLog(program));
    ...
    public static int loadShader(int shaderType, String shaderSource) {
        ...
        if (status[0] == 0) {
            Log.e("gaorui", "loadShader: compiler error");
            Log.e("gaorui", "loadShader: " + GLES20.glGetShaderInfoLog(shader) );
    ...
    public static void checkError() {
        if (GLES20.glGetError() != GLES20.GL_NO_ERROR) {
            Log.e("gaorui", "createOutputTexture: " + GLES20.glGetError() );
        }
    }
    ...
    public static int loadBitmapTexture(Bitmap bitmap) {
        ...
        if (textureIds[0] == 0) {
            Log.e("gaorui", "loadBitmapTexture: glGenTextures is 0");
            return -1;
        }
        //绑定纹理
